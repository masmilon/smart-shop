                ...
                <div class="login-grids">
                    <div class="login">
                        <div class="login-bottom">
                            ...
                            @if ($errors->first('reg_name') || $errors->first('reg_email') ||
                            ...
                            <form action="/register" method="POST">
                                ...
                                <div class="sign-up">
                                    <h4>Name :</h4>
                                    <input type="text" value="{{ old('reg_name') }}" name="reg_name"
                                        onfocus="this.value = '';"
                                        onblur="if (this.value == '') {this.value = 'Type here';}" required="">
                                </div>
                                <div class="sign-up">
                                    <h4>Email :</h4>
                                    <input type="text" value="{{ old('reg_email') }}" name="reg_email"
                                        onfocus="this.value = '';"
                                        onblur="if (this.value == '') {this.value = 'Type here';}" required="">
                                </div>
                                <div class="sign-up">
                                    <h4>Password :</h4>
                                    <input type="password" value="Password" name="reg_password"
                                        onfocus="this.value = '';"
                                ...
                                <div class="sign-up">
                                    ...
                                    <input type="password" value="Password" name="reg_password_confirmation"
                                        onfocus="this.value = '';"
                                        onblur="if (this.value == '') {this.value = 'Password';}" required="">
